...
# Time-stamp: <2025-09-23 16:49:41 qftele>
################################################################################
# Innovus attributes
#
...
create_flow_step -name init_innovus -owner flow {
    ...
    set_db place_detail_filler_gap_min_gap                    [expr 0.14 * 2.0]
    ...
    #-------------------------------------------------------------------------------
    set_db route_early_global_bottom_routing_layer            [get_db [get_db layers Metal1] .route_index]
    ...
    set_db route_design_bottom_routing_layer                  [get_db [get_db layers Metal1] .route_index]
