...
# Time-stamp: <2025-09-29 00:40:20 qftele>
...
create_flow_step -name genus_to_modus -owner flow {
    ...
    # Copy templates
    file copy -force [get_db flow_vars_dft_data_directory]/runmodus_atpg.tcl $out_dir/runmodus.tcl
    file copy -force [get_db flow_vars_dft_data_directory]/run_simulator $out_dir
    file copy -force [get_db flow_vars_dft_data_directory]/generate_mem_udp.do $out_dir
