...
# Generated on: Fri Nov 14 15:34:45 EET 2025 (Fri Nov 14 13:34:45 UTC 2025)
...
set logfile fv/datapath_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/datapath_top -revised fv_map -use_rtl_names
...
set_naming_rule "_" "" -field_delimiter -golden
set_naming_rule "%s_%d" -instance_array -golden
...
set_hdl_options -max_for_loop_size 32768
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 rtl/ram_wrapper.sv rtl/matmul_sync_wrapper.sv rtl/tico_gpdk045.sv rtl/datapath_top.sv
elaborate_design -golden -root {datapath_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/datapath_top/fv_map.v.gz
...
read_power_intent -insert_isolation -1801 -golden /home/student/16/ex8/flow_datapath_top_1/constraints/datapath_top.upf
read_power_intent -1801 -revised fv/datapath_top/fv_map.upf
...
set_analyze_option -mapping_file fv/datapath_top/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.datapath_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.datapath_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.datapath_top.rtl.fv_map.rpt
