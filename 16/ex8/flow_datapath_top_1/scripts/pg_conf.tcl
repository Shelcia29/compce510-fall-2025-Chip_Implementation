...
puts $FH "    \{ METAL Metal10_VDD stripe_Metal10 \{ NET VDD \} \{ STEPDISTANCE 16 BEFORESNAPPING \} \{ OFFSET 8.4 * \} \}"
puts $FH "    \{ METAL Metal10_VSS stripe_Metal10 \{ NET VSS \} \{ STEPDISTANCE 16 BEFORESNAPPING \} \{ OFFSET 17.2 * \} \}"
puts $FH "  \}"
puts $FH "  \{ LAYER Metal11 \{ SNAPTO GRID \}"
puts $FH "    \{ METAL Metal11_VDD stripe_Metal11 \{ NET VDD \} \{ STEPDISTANCE 16 BEFORESNAPPING \} \{ OFFSET * 7.3 \} \}"
puts $FH "    \{ METAL Metal11_VSS stripe_Metal11 \{ NET VSS \} \{ STEPDISTANCE 16 BEFORESNAPPING \} \{ OFFSET * 16.575 \} \}"
puts $FH "  \}"
puts $FH "\}"
close $FH
