...
#  Created on Fri Nov 14 14:52:04 2025                
#                                                     
#######################################################
...
if {[catch {init_flow  {flow_script /home/student/16/ex8/flow_matmul_sync_1/cadence_flow_scripts/scripts/run_flow.tcl yaml_script {} flow_no_check 0 parent_uuid {} previous_uuid 2058085e-3a57-47c0-a225-569c61ab8d1a top_dir /home/student/16/ex8/flow_matmul_sync_1 flow_dir . status_file /home/student/16/ex8/flow_matmul_sync_1/flow.status.d/cts metrics_file /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/cts run_tag {} db {enc /home/student/16/ex8/flow_matmul_sync_1/dbs/prects.enc matmul_sync {}} db_is_ref_run 0 branch {} caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ASIC-vm flowtool_pid 3079} flow {flow flow:block dir . db {enc dbs/prects.enc matmul_sync {}} branch {} tool innovus caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ASIC-vm flowtool_pid 3079} uuid 2058085e-3a57-47c0-a225-569c61ab8d1a tool_options {} start_step {tool innovus flow flow:block canonical_path {.steps flow:cts .steps flow_step:block_start} step flow_step:block_start features {} str cts.block_start} process_branch_trunk 1} flow_name flow:block first_step {tool innovus flow flow:block canonical_path {.steps flow:cts .steps flow_step:block_start} step flow_step:block_start features {} str cts.block_start} interactive 0 interactive_run 0 enabled_features {report_lec synth_spatial pnr_db_handoff add_scan generate_models opt_signoff} inject_tcl {} trunk_process 1 aum_upload false tool_options {} overwrite 0 last_step {tool innovus flow flow:block canonical_path {.steps flow:cts .steps flow:report_postcts .steps flow_step:report_finish} step flow_step:report_finish features {} str cts.report_postcts.report_finish} log_prefix /home/student/16/ex8/flow_matmul_sync_1/logs/cts}; run_flow -from {tool innovus flow flow:block canonical_path {.steps flow:cts .steps flow_step:block_start} step flow_step:block_start features {} str cts.block_start} -to {tool innovus flow flow:block canonical_path {.steps flow:cts .steps flow:report_postcts .steps flow_step:report_finish} step flow_step:report_finish features {} str cts.report_postcts.report_finish}} msg]} { puts [concat {Tcl error:} $errorInfo]; set fp [open {/home/student/16/ex8/flow_matmul_sync_1/flow.status.d/cts} a]; puts $fp {}; puts $fp [list [list script run_tcl status error flow {flow:block} branch {} flow_working_directory {.} flow_starting_db {enc /home/student/16/ex8/flow_matmul_sync_1/dbs/prects.enc matmul_sync {}} {tool_options} {} steps_run [get_db flow_step_canonical_current] msg $msg]]; close $fp; exit 1 };
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_metric -id current /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/cts -previous 2058085e-3a57-47c0-a225-569c61ab8d1a
...
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_db /home/student/16/ex8/flow_matmul_sync_1/dbs/prects.enc
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): source /home/student/16/ex8/flow_matmul_sync_1/cadence_flow_scripts/scripts/run_flow.tcl
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_metric -merge -id current /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/cts -previous 2058085e-3a57-47c0-a225-569c61ab8d1a
set db [get_db flow_starting_db]
set flow [lindex [get_db flow_hier_path] end]
set setup_views [get_feature $flow -feature setup_views]
set hold_views [get_feature $flow -feature hold_views]
...
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): write_db -sdc /home/student/16/ex8/flow_matmul_sync_1/dbs/cts.enc
