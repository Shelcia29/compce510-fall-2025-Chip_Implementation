...
#  Created on Fri Nov 14 14:58:56 2025                
#                                                     
#######################################################
...
if {[catch {init_flow  {flow_script /home/student/16/ex8/flow_matmul_sync_1/cadence_flow_scripts/scripts/run_flow.tcl yaml_script {} flow_no_check 0 parent_uuid {} previous_uuid fa8331ed-e515-4a37-8ae3-86b2fded0da5 top_dir /home/student/16/ex8/flow_matmul_sync_1 flow_dir . status_file /home/student/16/ex8/flow_matmul_sync_1/flow.status.d/route metrics_file /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/route run_tag {} db {enc /home/student/16/ex8/flow_matmul_sync_1/dbs/postcts.enc matmul_sync {}} db_is_ref_run 0 branch {} caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ASIC-vm flowtool_pid 3079} flow {flow flow:block dir . db {enc dbs/postcts.enc matmul_sync {}} branch {} tool innovus caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ASIC-vm flowtool_pid 3079} uuid fa8331ed-e515-4a37-8ae3-86b2fded0da5 tool_options {} start_step {tool innovus flow flow:block canonical_path {.steps flow:route .steps flow_step:block_start} step flow_step:block_start features {} str route.block_start} process_branch_trunk 1} flow_name flow:block first_step {tool innovus flow flow:block canonical_path {.steps flow:route .steps flow_step:block_start} step flow_step:block_start features {} str route.block_start} interactive 0 interactive_run 0 enabled_features {report_lec synth_spatial pnr_db_handoff add_scan generate_models opt_signoff} inject_tcl {} trunk_process 1 aum_upload false tool_options {} overwrite 0 last_step {tool innovus flow flow:block canonical_path {.steps flow:route .steps flow:report_postroute .steps flow_step:report_finish} step flow_step:report_finish features {} str route.report_postroute.report_finish} log_prefix /home/student/16/ex8/flow_matmul_sync_1/logs/route}; run_flow -from {tool innovus flow flow:block canonical_path {.steps flow:route .steps flow_step:block_start} step flow_step:block_start features {} str route.block_start} -to {tool innovus flow flow:block canonical_path {.steps flow:route .steps flow:report_postroute .steps flow_step:report_finish} step flow_step:report_finish features {} str route.report_postroute.report_finish}} msg]} { puts [concat {Tcl error:} $errorInfo]; set fp [open {/home/student/16/ex8/flow_matmul_sync_1/flow.status.d/route} a]; puts $fp {}; puts $fp [list [list script run_tcl status error flow {flow:block} branch {} flow_working_directory {.} flow_starting_db {enc /home/student/16/ex8/flow_matmul_sync_1/dbs/postcts.enc matmul_sync {}} {tool_options} {} steps_run [get_db flow_step_canonical_current] msg $msg]]; close $fp; exit 1 };
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_metric -id current /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/route -previous fa8331ed-e515-4a37-8ae3-86b2fded0da5
...
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_db /home/student/16/ex8/flow_matmul_sync_1/dbs/postcts.enc
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): source /home/student/16/ex8/flow_matmul_sync_1/cadence_flow_scripts/scripts/run_flow.tcl
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_metric -merge -id current /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/route -previous fa8331ed-e515-4a37-8ae3-86b2fded0da5
set db [get_db flow_starting_db]
set flow [lindex [get_db flow_hier_path] end]
set setup_views [get_feature $flow -feature setup_views]
set hold_views [get_feature $flow -feature hold_views]
...
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): write_db -sdc /home/student/16/ex8/flow_matmul_sync_1/dbs/route.enc
