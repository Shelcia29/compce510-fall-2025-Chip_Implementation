...
#  Created on Fri Nov 14 15:14:59 2025                
#                                                     
#######################################################
...
if {[catch {init_flow  {flow_script /home/student/16/ex8/flow_matmul_sync_1/cadence_flow_scripts/scripts/run_flow.tcl yaml_script {} flow_no_check 0 parent_uuid {} previous_uuid c0254cca-0f37-4e92-adcf-874da3fa625e top_dir /home/student/16/ex8/flow_matmul_sync_1 flow_dir . status_file /home/student/16/ex8/flow_matmul_sync_1/flow.status.d/opt_signoff metrics_file /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/opt_signoff run_tag {} db {enc /home/student/16/ex8/flow_matmul_sync_1/dbs/postroute.enc matmul_sync {}} db_is_ref_run 0 branch {} caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ASIC-vm flowtool_pid 3079} flow {flow flow:block dir . db {enc dbs/postroute.enc matmul_sync {}} branch {} tool innovus caller_data {group 0 process_branch 0 trunk_process 1 flowtool_hostname ASIC-vm flowtool_pid 3079} uuid c0254cca-0f37-4e92-adcf-874da3fa625e tool_options {} start_step {tool innovus flow flow:block canonical_path {.steps flow:opt_signoff .steps flow_step:block_start} step flow_step:block_start features {} str opt_signoff.block_start} process_branch_trunk 1} flow_name flow:block first_step {tool innovus flow flow:block canonical_path {.steps flow:opt_signoff .steps flow_step:block_start} step flow_step:block_start features {} str opt_signoff.block_start} interactive 0 interactive_run 0 enabled_features {report_lec synth_spatial pnr_db_handoff add_scan generate_models opt_signoff} inject_tcl {} trunk_process 1 aum_upload false tool_options {} overwrite 0 last_step {tool innovus flow flow:block canonical_path {.steps flow:opt_signoff .steps flow_step:innovus_to_tempus} step flow_step:innovus_to_tempus features {} str opt_signoff.innovus_to_tempus} log_prefix /home/student/16/ex8/flow_matmul_sync_1/logs/opt_signoff}; run_flow -from {tool innovus flow flow:block canonical_path {.steps flow:opt_signoff .steps flow_step:block_start} step flow_step:block_start features {} str opt_signoff.block_start} -to {tool innovus flow flow:block canonical_path {.steps flow:opt_signoff .steps flow_step:innovus_to_tempus} step flow_step:innovus_to_tempus features {} str opt_signoff.innovus_to_tempus}} msg]} { puts [concat {Tcl error:} $errorInfo]; set fp [open {/home/student/16/ex8/flow_matmul_sync_1/flow.status.d/opt_signoff} a]; puts $fp {}; puts $fp [list [list script run_tcl status error flow {flow:block} branch {} flow_working_directory {.} flow_starting_db {enc /home/student/16/ex8/flow_matmul_sync_1/dbs/postroute.enc matmul_sync {}} {tool_options} {} steps_run [get_db flow_step_canonical_current] msg $msg]]; close $fp; exit 1 };
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_metric -id current /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/opt_signoff -previous c0254cca-0f37-4e92-adcf-874da3fa625e
...
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_db /home/student/16/ex8/flow_matmul_sync_1/dbs/postroute.enc
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): source /home/student/16/ex8/flow_matmul_sync_1/cadence_flow_scripts/scripts/run_flow.tcl
#@ (init_flow): cd /home/student/16/ex8/flow_matmul_sync_1
#@ (init_flow): read_metric -merge -id current /home/student/16/ex8/flow_matmul_sync_1/flow.metrics.d/opt_signoff -previous c0254cca-0f37-4e92-adcf-874da3fa625e
set db [get_db flow_starting_db]
set flow [lindex [get_db flow_hier_path] end]
set setup_views [get_feature $flow -feature setup_views]
set hold_views [get_feature $flow -feature hold_views]
...
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): write_db -sdc /home/student/16/ex8/flow_matmul_sync_1/dbs/opt_signoff.enc
#@ (run_flow): push_snapshot_stack
...
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): push_snapshot_stack
if {([get_feature -feature add_pvs_fill] && [is_flow -quiet -after flow:opt_signoff.run_pvs_metal_fill]) ||    ([get_feature -feature add_pegasus_beol_fill] && [is_flow -quiet -after flow:opt_signoff.run_pegasus_metal_fill])} {...}
extract_rc
#@ (run_flow): pop_snapshot_stack
#@ (run_flow): push_snapshot_stack
...
#@ (run_flow): push_snapshot_stack
#@ (run_flow): pop_snapshot_stack
#@ (flow_step:write_lec_constraints)  2:     #- Extend flow report name based on context
#@ (flow_step:write_lec_constraints)  3:     if {[is_flow -quiet -inside flow:sta] || [is_flow -quiet -inside flow:sta_dmmmc] || [is_flow -quiet -inside flow:sta_eco]} {
#@                                     : 	if {![regexp {sta$} [get_db flow_report_name]]} {
#@                                     : 	    set_db flow_report_name [expr {[string is space [get_db flow_report_name]] ? "sta" : "[get_db flow_report_name].sta"}]
#@                                     : 	}
#@                                     :     } elseif {[is_flow -quiet -inside flow:ir_early_static] || [is_flow -quiet -inside flow:ir_early_dynamic]} {
...
#@                                     :     } else {
#@                                     :     }
#@ (flow_step:write_lec_constraints) 20:     #- Create report directory (if necessary)
#@ (flow_step:write_lec_constraints) 21:     file mkdir [file normalize [file join [get_db flow_report_directory] [get_db flow_report_name]]]
#@ (run_flow): push_snapshot_stack
