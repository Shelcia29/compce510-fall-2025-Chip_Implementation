...
# Generated on: Fri Nov 14 14:40:21 EET 2025 (Fri Nov 14 12:40:21 UTC 2025)
...
set logfile fv/matmul_sync/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/matmul_sync -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 rtl/multiplier.sv rtl/matmul_sync.sv
elaborate_design -golden -root {matmul_sync} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/matmul_sync/fv_map.v.gz
...
read_power_intent -insert_isolation -1801 -golden /home/student/16/ex8/flow_matmul_sync_1/constraints/matmul_sync.upf
read_power_intent -1801 -revised fv/matmul_sync/fv_map.upf
...
set_analyze_option -mapping_file fv/matmul_sync/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.matmul_sync.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.matmul_sync.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.matmul_sync.rtl.fv_map.rpt
